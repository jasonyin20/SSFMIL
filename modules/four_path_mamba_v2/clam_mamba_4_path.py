...
class CLAM_MB_four_path(CLAM_SB):
    def __init__(self, gate=True, size_arg="small", dropout=0., k_sample=8, n_classes=2,
                 instance_loss_fn=SmoothTop1SVM(2), subtyping=False, act='relu', rrt=False):
        nn.Module.__init__(self)
        self.size_dict = {"small": [1024, 512, 256], "big": [512, 512, 384]}
        size = self.size_dict[size_arg]
        ...
        self.n_classes = n_classes
        self.subtyping = subtyping
        # self.VisionMamba_v3 = VisionMamba_v3(
        #     embed_dim=512, depth=1, rms_norm=True, residual_in_fp32=True, fused_add_norm=True,
        #     final_pool_type='all', if_abs_pos_embed=True, if_rope=False, if_rope_residual=False, bimamba_type="v2",
        #     if_cls_token=False, if_devide_out=False, use_middle_cls_token=False)

        #self.Block_mamba = Block_mamba(dim=size[0], drop_path=0.0)  # R50 1024 PLIP 512

        self.Block_mamba = Block_mamba_with_fusion(dim=size[0], drop_path=0.0)  # R50 1024 PLIP 512
    ...
    def forward(self, h, label=None, instance_eval=True, return_features=False, attention_only=False):
        ...
        ps = h.size(1)
        # print(h.shape)
        h = self.Block_mamba(h)  # nW*B, region_size*region_size, C
...
class CLAM_MB_mamba(CLAM_SB):
    def __init__(self, gate=True, size_arg="small", dropout=0., k_sample=8, n_classes=2,
        ...
        #     final_pool_type='all', if_abs_pos_embed=True, if_rope=False, if_rope_residual=False, bimamba_type="v2",
        #     if_cls_token=False, if_devide_out=False, use_middle_cls_token=False)
        self.Block_mamba = Block_valia_mamba(dim=size[0], drop_path=0.0)  # R50 1024 PLIP 512
...
class CLAM_MB_bi_mamba(CLAM_SB):
    def __init__(self, gate=True, size_arg="small", dropout=0., k_sample=8, n_classes=2,
                 instance_loss_fn=SmoothTop1SVM(2), subtyping=False, act='relu', rrt=False):
        nn.Module.__init__(self)
        self.size_dict = {"small": [1024, 512, 256], "big": [512, 512, 384]}
        ...
        #     final_pool_type='all', if_abs_pos_embed=True, if_rope=False, if_rope_residual=False, bimamba_type="v2",
        #     if_cls_token=False, if_devide_out=False, use_middle_cls_token=False)
        self.Block_mamba = Block_bi_mamba(dim=size[0], drop_path=0.0)  # R50 1024 PLIP 512
...
class CLAM_MB_sr_mamba(CLAM_SB):
    def __init__(self, gate=True, size_arg="small", dropout=0., k_sample=8, n_classes=2,
                 instance_loss_fn=SmoothTop1SVM(2), subtyping=False, act='relu', rrt=False):
        nn.Module.__init__(self)
        self.size_dict = {"small": [1024, 512, 256], "big": [512, 512, 384]}
        ...
        #     final_pool_type='all', if_abs_pos_embed=True, if_rope=False, if_rope_residual=False, bimamba_type="v2",
        #     if_cls_token=False, if_devide_out=False, use_middle_cls_token=False)
        self.Block_mamba = Block_sr_mamba(dim=size[0], drop_path=0.0)  # R50 1024 PLIP 512
...
class CLAM_MB_four_mamba(CLAM_SB):
    def __init__(self, gate=True, size_arg="small", dropout=0., k_sample=8, n_classes=2,
                 instance_loss_fn=SmoothTop1SVM(2), subtyping=False, act='relu', rrt=False):
        nn.Module.__init__(self)
        self.size_dict = {"small": [1024, 512, 256], "big": [512, 512, 384]}
        ...
        #     final_pool_type='all', if_abs_pos_embed=True, if_rope=False, if_rope_residual=False, bimamba_type="v2",
        #     if_cls_token=False, if_devide_out=False, use_middle_cls_token=False)
        self.Block_mamba = Block_four_mamba(dim=size[0], drop_path=0.0)  # R50 1024 PLIP 512
