...
from modules.SRMamba.srmamba import SRMamba
...
class MambaMIL(nn.Module):
    ...
    def forward(self, x):
        ...
        h = torch.bmm(A, h) # [classifierB, K, 512]
        h = h.squeeze(0)
        # ---->predict
...
if __name__ == '__main__':
    model = MambaMIL(n_classes=2, dropout=0.0, act='relu', n_features=1024, layer=2, rate=10, type="SRMamba").cuda()
