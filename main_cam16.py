...
def one_fold(args,k,ckc_metric,train_p, train_l, test_p, test_l,val_p,val_l):
    ...
    if args.model == 'attmil':
        ...
        #model = clam_with_Transformer.CLAM_MB_with_Transformer(n_classes=args.n_classes,dropout=args.dropout,act=args.act).to(device)
        ...
        # model = SRMambaMIL.MambaMIL(n_classes=2, dropout=0.25, act='relu', n_features=512, layer=2, rate=5,
        #                             type="SRMamba").cuda()
        ...
        i_classifier = mdmil.FCLayer(in_size=512, out_size=args.n_classes).to(device)
    ...
    for i, data in enumerate(loader):
        ...
        with amp_autocast():
            ...
            if args.loss == 'ce':
                ...
                if args.model in ('dsmil'):
                    cls_loss = criterion(cls_loss.view(batch_size, -1), one_hot(label.view(batch_size,-1).float(),num_classes=2))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', default='E:\\SSFNet\\camelyon\\r50', type=str, help='Dataset root path')
    ...
    parser.add_argument('--max_epoch', default=100, type=int, help='Number of max training epochs in the earlystopping [130]')
    ...
    args.model_path = r'D:\SSF_MIL_V2_COPY\Result\2021\cam16\clam_mb_SSF_without_fusion_r50_SEED_2021_5'
